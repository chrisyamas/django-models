...
class ThingsTests(TestCase):
    def setUp(self):
        ...
        Snack.objects.create(name="crackers", purchaser=purchaser, description="tasty, crunchy")
    ...
    def test_list_page_context(self):
        ...
        self.assertEqual(snacks[0].name, "crackers")
        self.assertEqual(snacks[0].purchaser.username, "tester")
        self.assertEqual(snacks[0].description, "tasty, crunchy")
    ...
    def test_detail_page_context(self):
        ...
        self.assertEqual(snack.name, "crackers")
        self.assertEqual(snack.purchaser.username, "tester")
        self.assertEqual(snack.description, "tasty, crunchy")